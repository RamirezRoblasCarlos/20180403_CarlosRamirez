 ...
 * @author Carlos
 */
@WebServlet(name = "FormularioClase", urlPatterns = {"/FormularioClase"})
public class FormularioClase extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FormularioClase</title>");
